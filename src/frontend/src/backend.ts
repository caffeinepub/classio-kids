...
import type { BulkCreateResult as _BulkCreateResult, Student as _Student, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addStudent(arg0: StudentInput): Promise<string> {
        if (this.processError) {
            try {
    ...
    async addStudents(arg0: Array<StudentInput>): Promise<Array<BulkCreateResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.addStudents(arg0);
    ...
    async getAllValidStudents(): Promise<Array<Student>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllValidStudents();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isRollNumberDuplicate(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isRollNumberDuplicate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async studentLogin(arg0: string, arg1: string): Promise<Student> {
        if (this.processError) {
            try {
...
function from_candid_BulkCreateResult_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BulkCreateResult): BulkCreateResult {
...
function from_candid_opt_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Student]): Student | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        student: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.student)),
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        studentId: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.studentId)),
        name: value.name
    };
}
...
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BulkCreateResult>): Array<BulkCreateResult> {
    return value.map((x)=>from_candid_BulkCreateResult_n2(_uploadFile, _downloadFile, x));
}
